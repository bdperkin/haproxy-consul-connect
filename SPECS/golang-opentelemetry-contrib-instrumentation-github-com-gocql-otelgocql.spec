...
%global goaltipaths     github.com/open-telemetry/opentelemetry-go-contrib/instrumentation/github.com/gocql/gocql/otelgocql
...
Name:           %{goname}
Release:        1%{?dist}
Summary:        Package otelgocql instruments the github
